...
import com.jiacheng.firstapplication.Dialogs.OnOkListener;
import com.jiacheng.firstapplication.KCalendar.OnCalendarDateChangedListener;
import com.jiacheng.firstapplication.KCalendar.OnCalendarClickListener;
...
public class UserCalendarActivity extends BaseActivity {
    ...
    ArrayList<UserCalendar> userCalendars = new ArrayList<>();
    ArrayList<UserCalendar> userCalendarsOfSelectedDate = new ArrayList<>();
    ...
    public UserCalendarActivity() {
        super(R.layout.activity_user_calendar, "日程记录");
    }
                ...
                Dialogs.showSimpleDialog(UserCalendarActivity.this,
                        "确定删除这条记录吗？", true, new OnOkListener() {
                            ...
                            public void onOk() {
                                ...
                                Iterator<UserCalendar> it1 = userCalendarsOfSelectedDate
                                        .iterator();
                                while (it1.hasNext()) {
