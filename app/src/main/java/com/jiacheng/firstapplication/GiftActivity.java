...
import com.jiacheng.firstapplication.model.Gift;
import com.jiacheng.firstapplication.model.GiftStyle;
...
public class GiftActivity extends BaseActivity {
            ...
            public void onTextChanged(CharSequence s, int start, int before,
                ...
                try {
                    int quantity = Integer.parseInt(quantityEditText.getText()
                            .toString());
                    priceTextView
                            .setText((selectedGiftStyle.discount == 0 ? selectedGiftStyle.price
    ...
    void selectStyle(GiftStyle style) {
        ...
        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) styleSelectedImageView
                .getLayoutParams();
